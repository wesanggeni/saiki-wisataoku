...
import { setAkomodasi } from '../../redux/actions/dataActions';
import {
  Dimensions,
  StyleSheet,
  FlatList,
...
export const ScreenMain = (props) => {
  ...
  useEffect(() => {
    if (mounted == true && props.dataAkomodasi.length == 0) {
  ...
  return (
    ...
    <Divider/>
      <ImageBackground
        ...
        style={{resizeMode: "repeat", height: 600}}>
        <ScrollView>
